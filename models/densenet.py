...
class DenseNet3(nn.Module):
    def __init__(self, depth, num_classes, growth_rate=12,
                 reduction=0.5, bottleneck=True, dropRate=0.0, dataset='cifar'):
        super(DenseNet3, self).__init__()
        self.pool_dim = 8 if dataset != 'stl10' else 24
...
class DenseNet3DICE(nn.Module):
    def __init__(self, depth, num_classes, growth_rate=12,
                 reduction=0.5, bottleneck=True, dropRate=0.0, dataset='cifar', p=None, info=None):
        super(DenseNet3DICE, self).__init__()
        self.pool_dim = 8 if dataset != 'stl10' else 24
        in_planes = 2 * growth_rate
        n = (depth - 4) / 3
        if bottleneck == True:
